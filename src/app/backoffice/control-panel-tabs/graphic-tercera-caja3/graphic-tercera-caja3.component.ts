...
@Component({
  selector: 'app-graphic-tercera-caja3',
  imports: [BaseChartDirective],
  templateUrl: './graphic-tercera-caja3.component.html',
  styleUrl: './graphic-tercera-caja3.component.scss'
})
export class GraphicTerceraCaja3Component implements OnInit {
